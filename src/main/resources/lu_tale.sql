...
CREATE TABLE `t_contents`  (
  ...
  `article` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '内容文字',
  `authorId` int(10) UNSIGNED DEFAULT 0,
...
ALTER TABLE t_contents ADD COLUMN weight INT DEFAULT 0;
-- 0代表默认显示权重 权重越大显示越靠前
--
...
-- Records of t_users
-- ----------------------------
INSERT INTO `t_users` VALUES (1, 'admin', 'a66abb5684c45962d887564f08346e8d', '614042560@qq.com', NULL, 'admin', 1490756162, 0, 0, 'visitor');
