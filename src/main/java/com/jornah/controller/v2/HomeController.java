...
//import com.wip.model.dto.ArticleSaveBo;
...
//        PageInfo<Article> articles = articleService.getArticlesByCond(cond, page, limit);
//
...
//    public APIResponse<PageInfo<ArticleVo>> archives(
//            @ApiParam(name = "page", value = "页数", required = false)
//            @RequestParam(name = "page", required = false, defaultValue = "1")
//                    int page,
...
//        PageInfo<Article> articles = articleService.getArticlesByCond(cond, page, pageSize);
//        List<ArticleVo> collect = articles.getList().stream().map(ArticleVo::convertFrom).collect(Collectors.toList());
//        PageInfo<ArticleVo> articlesMetaInfo = PageInfo.of(collect);
...
//    public APIResponse<List<Article>> categoriesDetail(
...
//        }
//        List<Article> articles = articleService.getArticleByCategory(category.getName());
...
//    public APIResponse<List<Article>> tagsDetail(
//            HttpServletRequest request,
...
//        List<Article> articles = articleService.getArticleByTags(tags);
//        request.setAttribute("articles", articles);
//        return success(articles);
//    }
//
...
//    public APIResponse<ArticleSaveBo> detail(
...
//        articleService.logVisit(cid,  article.getTitle(), request);
//        if (!articleService.isFromSameIp(cid, request)) {
//            // 更新文章的点击量
//            articleService.updateArticleHits(article.getCid(), article.getHits());
//        }
//        // 获取评论
//        List<Comment> comments = commentService.getCommentsByCId(cid);
//        return success(new ArticleSaveBo(article,comments));
//    }
//
